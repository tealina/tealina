        ...
        <KBarPositioner className="bg-black/60">
          <KBarAnimator className="w-50% dark:bg-[#101010] bg-white rounded-md px-4 py-2">
            <div className="py-1 px-1">
              <KBarSearch
                className="w-full  border-b-solid dark:border-white/45 border-b-1px rounded-none! border-b-black/45  bg-transparent border-none outline-none 
  ...
  return (
    <KBarResults
      ...
      onRender={({ item, active }) => (
        <div className="py-1 px-1">
          <div
            className={`px-4 py-3 rounded-sm flex items-center outline-solid 
             ${
               active
                 ? 'outline-indigo-6 text-indigo-6 dark:text-indigo! dark:outline-indigo!'
