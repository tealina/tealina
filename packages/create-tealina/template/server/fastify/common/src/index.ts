import './config/env' /** Why is the following line left blank? @see {@link https://github.com/microsoft/TypeScript/pull/48330}*/

import { asyncFlow } from 'fp-lite'
import { buildApp } from './app/index'
import { VDOC_BASENAME } from './app/docRoute'
